...
class ENG_BERT(nn.Module):
    ...
    def forward(self, text):
        ...
        # predictions = [batch size, sen len, output dim]
...
class Transformer(nn.Module):
    def __init__(self, cache_dir, args):
        ...
        #bert_config = BertConfig(self.bert.model.config.vocab_size, hidden_size=768, num_hidden_layers=12, num_attention_heads=12)
